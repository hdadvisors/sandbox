...
* 2-bedroom: 70% 3-person, 30% 4-person
* 3-bedroom: 50% 4-person, 50% 5-person
...
sA_person <- list(
    `bedroom0` = c(`person1` = 0.75, `person2` = 0.25),
    `bedroom1` = c(`person2` = 1),
    `bedroom2` = c(`person3` = 0.2, `person4` = 0.8),
    `bedroom3` = c(`person4` = 0.2, `person5` = 0.5, `person6` = 0.3)
  )
...
sA_person |>
  ...
  mutate(
    across(2:7, ~ as.character(.x)),
    across(2:7, ~ replace_na(.x, "-"))
    ) |> 
  kbl(booktabs = T, align = "lcccccc", linesep = "") |> 
  row_spec(0, bold = T) |> 
  kable_styling(full_width = T, latex_options = "hold_position")
...
sA_subsidy <- hud_ami |> 
  filter(
    ...
    str_detect(hh_size, "[123456]")    # 1-5 person households only
    ) |> 
  mutate(
...
* 1-bedroom: 100% 2-person
* 2-bedroom: 20% 2-person, 60% 3-person, 20% 4-person
* 3-bedroom: 20% 3-person, 40% 4-person, 20% 5-person, 20% 6-person
...
sC_person <- list(
    `bedroom1` = c(`person2` = 1),
    `bedroom2` = c(`person3` = 0.3, `person4` = 0.7),
    `bedroom3` = c(`person4` = 0.3, `person5` = 0.4, `person6` = 0.3)
  )
